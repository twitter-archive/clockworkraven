...
class EvaluationsIndexTest < ActionController::TestCase
  ...
  setup do
    ...
    Evaluation.all.each{|e| e.destroy }
  end

  test "Evaluations shown in table" do
    e1 = create :evaluation, :name => 'Name 1'
    e2 = create :evaluation, :name => 'Name 2'
